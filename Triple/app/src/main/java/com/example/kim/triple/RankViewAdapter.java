...
public class RankViewAdapter extends BaseAdapter {
    ...
    private ArrayList<RankViewItem> listViewItemList = new ArrayList<RankViewItem>() ;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.rankview_item, parent, false);
        }
        ...
        RankViewItem listViewItem = listViewItemList.get(position);
